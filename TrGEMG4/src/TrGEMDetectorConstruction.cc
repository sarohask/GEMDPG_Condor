...
void TrGEMDetectorConstruction::DefineMaterials() 
	{
  	...
  	mixtureDensity = (Argon->GetDensity() * 65/100.0 + CarbonDioxide->GetDensity() * 15/100.0 + CF4->GetDensity() * 20/100.0) ;
  	G4Material *ArCO2CF4 = new G4Material("Ar/CO2/CF4",mixtureDensity,3) ;
  	ArCO2CF4->AddMaterial(Argon, 0.65) ;
  	ArCO2CF4->AddMaterial(CarbonDioxide,0.15) ;
  	ArCO2CF4->AddMaterial(CF4,0.20) ;
